...
import (
	...
	application "github.com/victoralbino/go-hexagonal/application"
)
...
func (m *MockProductServiceInterface) Create(name string, price float64) (application.ProductServiceInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, price)
	ret0, _ := ret[0].(application.ProductServiceInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Disable mocks base method.
func (m *MockProductServiceInterface) Disable(product application.ProductInterface) (application.ProductServiceInterface, error) {
	m.ctrl.T.Helper()
...
// Enable mocks base method.
func (m *MockProductServiceInterface) Enable(product application.ProductInterface) (application.ProductServiceInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Get(id string) (application.ProductServiceInterface, error) {
	m.ctrl.T.Helper()
